...
class OneCallApi:
    def __init__(self,lat,lon,key,timeThrs=60):
        ...
        self._lon      = lon
        self._key      = key
        self._timeThrs = timeThrs # defaults to 60s
        self._ocadata  = dict()   # defaults to empty
        self._dataTime = 0        # defaults to 0s
...
class OneCallApiMinutely(OneCallApi):
    def __init__(self,lat,lon,key,timeThrs=60):
        super().__init__(lat,lon,key,timeThrs) # Init parent attributes
        self.__minutPrecDict = dict() # defaults to empty
...
class OneCallApiHourly(OneCallApi):
    def __init__(self,lat,lon,key,timeThrs=60):
        super().__init__(lat,lon,key,timeThrs) # Init parent attributes
        self.__hourlyDict = dict() # defaults to empty
...
class OneCallApiDaily(OneCallApi):
    def __init__(self,lat,lon,key,timeThrs=60):
        super().__init__(lat,lon,key,timeThrs) # Init parent attributes
        self.__dailyDict = dict() # defaults to empty
